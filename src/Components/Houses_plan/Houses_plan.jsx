...
import houses11 from '../../assets/images/1-xonali2.jpg'
...
import houses5 from '../../assets/images/3-xonali1.jpg'
import houses51 from '../../assets/images/3-xonali2.jpg'
import houses52 from '../../assets/images/3-xonali3.jpg'
import houses6 from '../../assets/images/4-xonali1.jpg'
import houses7 from '../../assets/images/4-xonali2.jpg'
        ...
        <div className="houses_box">
          ...
          {activeNumber === "3-xonali" && (
            <div className="houses_card_bottom2">
              ...
              <div className="houses_border"></div>
              <img src={houses51} alt="" className="houses_img" />
              <div className="houses_border"></div>
              <img src={houses52} alt="" className="houses_img" />
            </div>
          )}
